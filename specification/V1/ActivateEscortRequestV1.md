...
>[!IMPORTANT]
> The AV will reject the request if the escort position is in some way faulty. It should be expected that the positional values may vary between instances of the `ActivateEscortRequestV1` message for the same `EscortId`.
